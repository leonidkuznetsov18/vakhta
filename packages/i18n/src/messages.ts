...
export interface Messages {
  ...
  readonly admin: {
    ...
    readonly reports: {
      ...
      readonly lossPurpose: string;
      readonly lossCategory: string;
      readonly lossReason: string;
      readonly lossNoReason: string;
      ...
      readonly lossLost: string;
      readonly lossExplained: string;
      readonly lossExplainedHint: string;
      readonly lossDate: string;
      readonly lossEmployee: string;
      readonly lossZone: string;
      readonly lossFrom: string;
      readonly lossTo: string;
      readonly lossComment: string;
    ...
    readonly administration: {
      ...
      readonly users: {
        ...
        readonly deleteConfirm: string;
        readonly deleted: string;
        readonly selfDelete: string;
        readonly lastAdmin: string;
        readonly replaceRole: string;
        readonly roleReplaced: string;
