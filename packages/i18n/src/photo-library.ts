...
export const photoLibraryEn = {
  ...
  aiFeedback: 'Did AI help?',
  aiFeedbackHint:
    'Your saved assessment of the latest AI analysis, as in the photo editor. No assessment is not a negative answer.',
  aiFeedbackUnset: 'Not rated',
  date: 'Shift date',
  zone: 'Zone',
  employee: 'Worker',
  regions: 'Regions',
...
export const photoLibraryUk: PhotoLibraryMessages = {
  ...
  assessment: 'Оцінка фото',
  aiFeedback: 'Чи допоміг AI?',
  aiFeedbackHint:
    'Ваша збережена оцінка останнього аналізу AI, як у редакторі фото. Відсутність оцінки не означає відповідь «Ні».',
  aiFeedbackUnset: 'Не оцінено',
  date: 'Дата зміни',
  zone: 'Зона',
  employee: 'Працівник',
  regions: 'Областей',
...
export const photoLibraryRu: PhotoLibraryMessages = {
  ...
  assessment: 'Оценка фото',
  aiFeedback: 'Помог ли AI?',
  aiFeedbackHint:
    'Ваша сохранённая оценка последнего анализа AI, как в редакторе фото. Отсутствие оценки не означает ответ «Нет».',
  aiFeedbackUnset: 'Не оценено',
  date: 'Дата смены',
  zone: 'Зона',
  employee: 'Сотрудник',
  regions: 'Областей',
