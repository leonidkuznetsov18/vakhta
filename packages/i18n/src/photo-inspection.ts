...
export const inspectionEn = {
  ...
  hints: {
    ...
    polygon:
      'Outline an irregular object: click each corner and close the outline on the first one. Press again to stop drawing.',
    ...
    selectRegion: 'Open this region and highlight it on the photo; click again to fold it.',
...
export const inspectionUk: PhotoInspectionMessages = {
  ...
  hints: {
    ...
    polygon:
      'Обвести предмет неправильної форми: натискайте на кути і замкніть контур на першій точці. Повторне натискання вимикає малювання.',
    ...
    selectRegion: 'Розгорнути цю область і виділити її на фото; повторний клік згортає.',
...
export const inspectionRu: PhotoInspectionMessages = {
  ...
  hints: {
    ...
    polygon:
      'Обвести предмет неправильной формы: нажимайте на углы и замкните контур на первой точке. Повторное нажатие выключает рисование.',
    ...
    selectRegion: 'Развернуть эту область и выделить её на фото; повторный клик сворачивает.',
