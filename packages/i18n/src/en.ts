...
export const en: Messages = {
  ...
  admin: {
    ...
    administration: {
      ...
      terminals: {
        ...
        tokenHint:
          'The device token is shown once. Put it into VITE_KIOSK_DEVICE_TOKEN of the kiosk and never forward it in chats.',
  ...
  kiosk: {
    ...
    unauthorized: 'The terminal is not registered. Contact the administrator.',
    notConfigured: 'The terminal is not configured: no device token set.',
