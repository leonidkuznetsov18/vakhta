...
export const en: Messages = {
  ...
  photoDictionary: photoDictionaryEn,
  ...
  actions: {
    ...
    BACK_TO_WORK: '◀ Back',
    SUBMIT_HANDOVER: 'Send the report',
  ...
  handover: {
    ...
    photoButton: '📷 {item}',
    photoDone: '🖼 {item}',
    askPhoto: 'Send a photo: {item}. Shoot in good light, the whole area.',
    photoSaved: 'Photo "{item}" saved. Quality check runs in the background.',
    photoQualityHint:
      'Photo "{item}": {quality}. Better retake it, otherwise the result goes to manual review.',
  ...
  bonus: {
    ...
    monthCardTitle: '🏅 Results for {month}',
    monthCardPoints: 'You earned {points} points.',
    monthCardStats: 'Shifts: {shifts}. Approved checklists: {approved}.',
    monthCardEmployeeOfMonth: '🏆 You are the employee of the month! The best result of all.',
    monthCardUnitOfMonth: '🏭 Your unit "{unit}" is the unit of the month. You get +1 point.',
    monthCardMaster:
      '⭐ Your unit "{unit}" is the unit of the month. Thank you for running the shifts, you get +1 point.',
    monthCardWish:
      'Thank you for your work! May the next month be even better — every approved checklist is a point for you.',
  ...
  admin: {
    ...
    auth: {
      ...
      photoHint:
        'The photo shows in the sidebar and in the user list. The panel shrinks it to 256×256; without a photo a circle with the initials is shown.',
      photoTooLarge: 'The image could not be read. Pick a PNG, JPEG or WebP file up to 10 MB.',
    ...
    overview: {
      ...
      overdueAcceptances: 'Checklists awaiting the master',
    ...
    incidents: {
      ...
      queueTab: 'Incidents',
      statisticsScope:
        'All incident statuses for the selected site and period. Queue filters do not apply.',
      groupBy: 'Group by',
      periodTotals: 'Selected period totals',
      downtimeLabel: 'Downtime',
      resolutionLabel: 'Avg. resolution',
      impact: 'Impact',
    ...
    bonus: {
      ...
      historyKinds: {
        CHECKLIST_APPROVED: 'Approved checklist',
        UNIT_OF_MONTH: 'Unit of the month',
        MASTER_OF_MONTH: 'Master of the month',
      },
      historyKind: 'Reason',
      historyAll: 'All',
      historyDetail: 'Awards',
      historyUnits: 'Units',
      historyTruncated: 'Showing {shown} of {total}. Narrow the period or download the file.',
      historyDetailEmpty: 'No awards match this filter.',
      historyPeriod: 'Period',
      historyPoints: 'Points',
      historyChecklists: 'For checklists',
      historyAwards: 'Month-end awards',
      historyEmployees: 'Employees',
      historyEmpty: 'No points in this period yet.',
      from: 'From',
      to: 'To',
      ...
      employeeReportHint:
        'Every shift of the month with its checklist, the remarks on it, the decision of the shift master and the point it earned. Open a shift for the full text.',
      employeeShifts: 'Shifts of the month',
      employeeShiftsEmpty: 'No closed shifts or checklists this month.',
      employeeTrend: 'Points and remarks by month',
      employeeTrendEmpty: 'No points or remarks in the last twelve months.',
      shiftDate: 'Date',
      shiftTime: 'Time',
      zone: 'Zone',
      noZone: 'No zone',
      ...
      ownRemarks: 'Marked by the employee',
      reviewRemark: 'Acceptance by the next shift',
      masterDecision: 'Decision of the shift master',
      noRemarks: 'No remarks',
      openHandover: 'Open the report',
      openProfile: 'Open the profile',
      monthAwards: 'Month-end awards',
    ...
    reports: {
      ...
      to: 'To',
      build: 'Build',
      lossTitle: 'Time losses',
      lossPurpose:
        "Where a shift's time goes and why. Categories of non-working time in descending order: the two or three that make up most of the loss are visible at once.",
      lossCategory: 'Category',
      lossReason: 'Reason',
      lossNoReason: 'No reason recorded',
      lossMinutes: 'Minutes',
      lossShare: 'Share',
      ...
      lossLost: 'Outside main work',
      lossExplained: 'With a reason',
      lossExplainedHint:
        'How much of the lost time carries a reason. The rest sits in states with no explanation — until then the report shows where, not why.',
      lossDate: 'Date',
      lossEmployee: 'Employee',
      lossZone: 'Zone',
      lossFrom: 'From',
      lossTo: 'To',
      lossComment: 'Comment',
      ...
      options: 'View',
      chartType: 'Chart',
      chartTypes: { bar: 'Bars', line: 'Lines', stacked: 'Stacked bars' },
      series: 'Series on the chart',
      ...
      noSeries: 'Pick at least one series to draw the chart.',
      hoursUnit: 'h',
    ...
    audit: {
      ...
      actions: {
        ...
        'bonus.adjustment.update': 'Score adjustment edited',
        'bonus.adjustment.cancel': 'Score adjustment cancelled',
        'bonus.period.reopen': 'Period reopened',
        'bonus.review': 'Manual review finished',
        ...
        'incident.in_progress': 'Incident in progress',
        'incident.resolved': 'Incident resolved',
        'incident.closed': 'Incident closed',
        'incident.duplicate': 'Incident marked as duplicate',
        ...
        'checklist.create': 'Checklist created',
        'checklist.update': 'Checklist changed (new version)',
        'checklist.enable': 'Checklist enabled',
        'checklist.disable': 'Checklist disabled',
        'checklist.delete': 'Checklist deleted',
        'checklist.position.add': 'Checklist added to a position',
        'checklist.position.remove': 'Checklist removed from a position',
        ...
        'schedule.version.remind': 'Schedule acknowledgement reminder',
    ...
    administration: {
      ...
      employees: {
        ...
        checklist: 'Checklist',
        noChecklist: 'No checklist',
        checklists: 'Checklists of the position',
        addChecklist: 'Add an existing checklist',
      ...
      checklists: {
        ...
        items: 'Items',
        itemsSummary: '{items} items · {photos} photos',
        version: 'Version',
        versionLabel: 'v{n}',
        status: 'Status',
        active: 'Active',
        ...
        edit: 'Edit',
        updated: 'Checklist saved as a new version.',
        delete: 'Delete',
        deleteConfirm: 'Delete the checklist "{name}"?',
        deleted: 'Checklist deleted.',
        inUse:
          'Handover reports already refer to this checklist, so it cannot be deleted. Disable it instead.',
        disable: 'Disable',
        enable: 'Enable',
        statusChanged: 'Checklist status changed.',
        itemLabel: 'Item text',
        kind: 'Type',
        kinds: { CHECK: 'Check', NOTE: 'Message', PHOTO: 'Photo' },
        kindHints: {
          CHECK:
            'The employee marks "yes" or "remark"; a remark needs a category, a description and a safety assessment.',
          NOTE: 'The employee writes a text to the next shift.',
          PHOTO: 'The employee must send a photo; without it the report cannot be submitted.',
        },
        addItem: 'Add item',
        addPhoto: 'Add photo',
        ...
        moveUp: 'Move up',
        moveDown: 'Move down',
        fillDefault: 'Fill with the default',
        preview: 'How the employee sees it in the bot',
        noPhoto: 'Add at least one "Photo" item: a photo is mandatory.',
        noItems: 'Add at least one item.',
        emptyLabel: 'Fill in the item text.',
  ...
  ui: {
    ...
    common: {
      ...
      howItWorksHint: 'Show or hide the purpose and workflow steps.',
      faqHint: 'Open explanations and answers to common questions.',
      openGuideHint: 'Open the full instructions in a new tab.',
      retryHint: 'Try loading the data again.',
    ...
    guide: {
      ...
      bonus: {
        ...
        steps: [
          ...
          "Click an employee to open their report under the row: each shift with its checklist, remarks, the master's decision and the point, plus points by month.",
        ],
        faq: [
          {
        ...
        faq: [
          {
            ...
            a: 'Points say how a person worked. This says where the process makes people wait. They are different questions, and the second one pays more: fixing a process helps everyone at once.',
          },
          {
            q: 'Why is downtime not the biggest category?',
            a: 'That is expected. Downtime is only recorded when someone presses "Report a problem"; most of the time is lost in ordinary states — handover, preparation, waiting for a decision. That is why the report starts with categories rather than reasons.',
          },
          {
            q: 'What do I do with the result?',
            a: 'Take the top category, open its intervals, look at the longest ones and ask the people what happens there. The fix is a change to the process, not a conversation with a person: in those minutes the person is usually just waiting.',
          },
          {
            q: '"With a reason" is almost zero.',
            a: 'Then the report shows where, not why. Add reasons to the directory and get problems reported in the bot; the second level fills up from there.',
          },
          {
            q: 'How much money are we losing?',
            a: 'The report does not say: there is no output and no takt in this system. It ranks causes, it does not price them. Pricing needs one number from the production side — units finished per shift.',
          },
        ],
      },
      audit: {
    ...
    hints: {
      ...
      employeesChecklists:
        'Checklists are bound to the position, so they are shared by every employee with that position. Adding an existing checklist does not create a copy.',
      employeesImport:
      ...
      reportsOptions:
        'View settings apply to the screen: the chart and the table change at once, while the CSV/XLSX export always carries every column and row.',
      reportsSeries: 'Which numeric series to draw. Minutes are shown as hours on the chart.',
      reportsColumns: 'Hidden columns stay out of the print but remain in the export.',
      ...
      checklistsItems:
        'The order of items is the order of buttons in the bot. At most 40 items; keep the text short.',
      checklistsPhoto:
        'Every photo is a separate item: the employee sends it in the chat with the bot. A repeated photo replaces the previous one.',
      checklistsVersion:
        'A change creates a new version. Reports already submitted keep a link to the old version, so they can still be compared.',
      checklistsDelete:
        'A checklist can be deleted while no reports refer to it. Otherwise disable it: new shifts will not see it.',
