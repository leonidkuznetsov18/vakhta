...
- scheduling: шаблони, версії, призначення, потреба в персоналі, валідації (перетини, відпочинок між змінами, ліміти годин, рівномірність день/ніч), маршрут draft → in_review → published, сповіщення про зміни (підтвердження скасовано, ADR-0016).
- Бот: «Мій план» на місяць, сповіщення зі списком змін, нагадування «зміна скоро».
...
Вихід: працівник бачить опублікований план і отримує сповіщення про свої зміни.
