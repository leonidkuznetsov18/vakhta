...
domains). Epic: [#91](https://github.com/leonidkuznetsov18/vakhta/issues/91), published 2026-09-21 on owner request; #92 holds the open
decisions that gate implementation. Evidence: [engineering memory](features/multi-tenant-platform.md).
