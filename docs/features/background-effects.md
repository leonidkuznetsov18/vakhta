...
reminders, atomic escalations and recovery. The [bonus increment](../engineering/features/bonus-recalculation.md) implements API consumption,
source recovery and coherent closed-period results. Its production rollout remains to be verified.
