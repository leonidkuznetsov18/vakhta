...
const org = {
  ...
  terminals: [
    ...
    {
      id: 'terminal-preview-online',
      siteId: 'a0000000-0000-4000-8000-000000000001',
      name: 'Склад',
      checkpoint: 'BOTH',
      status: 'ACTIVE',
      paired: true,
      lastSeenAt: '2026-09-22T09:25:00.000Z',
      connectivity: 'ONLINE',
    },
    {
      id: 'terminal-preview-unpaired',
      siteId: 'a0000000-0000-4000-8000-000000000001',
      name: 'Цех стаканов',
      checkpoint: 'ENTRY',
      status: 'ACTIVE',
    ...
    {
      id: 'terminal-preview-disabled',
      siteId: 'a0000000-0000-4000-8000-000000000001',
      name: 'тест цех',
      checkpoint: 'EXIT',
      status: 'DISABLED',
      paired: true,
      lastSeenAt: '2026-09-08T06:50:00.000Z',
