...
applying upstream examples. Preserve Nest feature modules, the pure domain and frontend FSD. Add abstractions only for a demonstrated boundary. In-memory adapters do not replace required PostgreSQL transaction, concurrency or recovery tests.
