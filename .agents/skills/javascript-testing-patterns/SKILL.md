...
applying upstream examples. Use existing Vitest, Testing Library, MSW, fast-check and testcontainers. Select risk-based checks; do not install Jest, impose example coverage targets or replace real transaction tests with mocks.
