...
applying upstream examples. Use existing docs/adr conventions only for significant decisions. Example technologies, facts, commands and repository paths below are illustrative; do not apply them as project configuration.
