...
applying upstream examples. Design for the actual operational brief and existing semantic palette, i18n and accessibility rules. Studio/client history and marketing-page examples below are illustrative, not facts about this project.
