...
applying upstream examples. Keep Fastify, Drizzle, Zod contracts, DomainError mapping and existing durable effects. Translate TypeORM, class-validator, Express and Jest examples to established project patterns. Nest abstractions do not belong in the pure domain or standalone worker.
