...
| SC-43      | #18   | T043 / T044 / T045 | Export uses the requested complete scope and states filters/version/units; it does not expose hidden records or execute spreadsheet formulas  | Whole saved-version XLSX: DB8/HTTP1/catalog10 and API/UI10 checks, reviewed; live browser download not verified               |
