...
| ---------- | ----- | ------------------ | --------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------- |
| SC-01      | #11   | T022 / T023 / T024 | With four required and three eligible assigned people, show one vacancy; missing norms show unknown, not sufficient                           | Domain 4 + real-DB 1 + panel 2: 4/3 → 1 missing, unknown zone, D e/r notes; #11 accepted                                      |
| SC-02      | #12   | T025 / T026 / T027 | Candidate selection explains eligibility and revalidates it at commit; stale candidates cannot create conflicts                               | Candidates endpoint and editor list with reasons; commit re-evaluates; #12 accepted                                           |
| SC-03      | #17   | T040 / T041 / T042 | An approved absence covering the relevant business date is visible; pending/rejected states stay distinct and private attachments stay hidden | Approved absences block and mark days; pending stay distinct; only type/status/dates leave the API; #17 accepted              |
| SC-04      | #11   | T022 / T023 / T024 | A missing/expired required qualification blocks assignment under the approved policy; unknown qualification data is explicit                  | Save/revise reject unqualified or expired holder (422); editor names the qualification; #11 accepted                          |
| SC-05      | #12   | T025 / T026 / T027 | Overlapping active plans are rejected even when submitted concurrently; adjacent non-overlapping intervals remain valid                       | Real-DB concurrent cross-unit saves: one commits, adjacent accepted; #12 accepted                                             |
| SC-06      | #12   | T025 / T026 / T027 | Versioned configured limits produce actionable reasons at preview and commit, including overnight transitions                                 | Configured rest/hour rules with WARN/BLOCK severity, overnight rest test; #12 accepted                                        |
| SC-07      | #17   | T040 / T041 / T042 | Scheduled, acknowledged, started and unknown-presence states differ; missing QR evidence is not a proven no-show                              | Presence states from sessions with "no evidence" after start, never a no-show; #17 accepted                                   |
| SC-08      | #7    | T010 / T011 / T012 | Only affected recipients are admitted to existing notification delivery; queueing is not labelled delivery                                    | Metadata-only recipient fix (domain 8 / API 6) retained; queueing labelled as queued; #7 accepted                             |
| SC-09      | #7    | T010 / T011 / T012 | Draft edits remain unpublished; the permitted approver sees additions/removals/changes and affected people before publication                 | Publication review shows exact diff and affected workers without version numbers; #7 accepted                                 |
| SC-10      | #8    | T016 / T017 / T018 | The accepted authority matrix is enforced server-side; a master cannot alter another zone or publish without an explicit grant                | Domain 3, real-DB 2 (unit/zone master, denied publish/unit/zone), panel 3 journeys; D-01 defaults                             |
| SC-11      | #6    | T007 / T008 / T009 | A context-created shift inherits the selected date/person/zone; edits preserve all untouched metadata and show their scope                    | Redesign: context create inherits date/worker/zone; metadata regressions; desktop/390px/touch evidence                        |
| SC-12      | #6    | T007 / T008 / T009 | A master can open a zone/date and read its complete team; empty active zones remain visible                                                   | Redesign: zone rows with complete teams and empty active zones; master read-only view verified                                |
| SC-13      | #17   | T040 / T041 / T042 | Both assignments change atomically through the existing request route; rejection changes neither                                              | Swap decided in Requests revises both assignments in one transaction; details link there; #17 accepted                        |
| SC-14      | #17   | T040 / T041 / T042 | The action opens the correct request workflow and coverage impact; it cannot silently correct attendance                                      | Find replacement opens the Move editor with candidates; attendance untouched; #17 accepted                                    |
| SC-15      | #13   | T028 / T029 / T030 | A slot can exist without a person, fills once, and is counted separately from assigned people and requirements                                | Slots stored apart from assignments, ignored by coverage, counted in their own chip, fill once under a row lock; #13 accepted |
| SC-16      | #13   | T028 / T029 / T030 | Interest does not assign the slot; the authorized decision selects one candidate and preserves other responses/history                        | Bot responses only record interest; selection writes the draft, closes the offer and keeps every response; #13 accepted       |
| SC-17      | #12   | T025 / T026 / T027 | Totals show units and the chosen period; exceeding a configured limit follows the approved blocking/approval policy                           | Month-hour totals with other-unit context and site limit in reasons; #12 accepted                                             |
...
| SC-19      | #7    | T010 / T011 / T012 | Historical versions and decisions are read-only; navigation reveals actor/time/reason without replacing original evidence                     | Closed as not planned for the panel (owner version-removal decision 2026-09-13); audit/export retain record                   |
| SC-20      | #7    | T010 / T011 / T012 | The bot reflects published time/zone, suppresses superseded or absence-covered reminders and does not expose other people's plans             | Worker reminder/ACK suppression: 37 worker tests, 19 snapshot ACK; bot plan unchanged; #7 accepted                            |
| SC-21      | #6    | T007 / T008 / T009 | Switching from zone to employee grouping preserves the period and uses the same assignments                                                   | Redesign: zones/people grouping share identities and period; browser evidence in uk/en/ru                                     |
| SC-22      | #10   | T019 / T020 / T021 | A week spanning two months shows all dates; writes identify every affected version and never partially apply without an explicit outcome      | Seven-date weeks across month/year; adjacent month read only; DST duration; navigation journey test                           |
...
| SC-24      | #7    | T010 / T011 / T012 | A standard shift remains creatable from a template; historical times remain stable when templates change                                      | Template creation and stored-instant stability retained after redesign; #7 accepted                                           |
| SC-25      | #7    | T010 / T011 / T012 | A selected range follows a chosen cycle and anchor; fill-empty and replace have explicit, different previews                                  | Rotation replace/fill previews captured after redesign (`redesign-batch-*.png`); #7 accepted                                  |
| SC-26      | #14   | T031 / T032 / T033 | Copy maps source to target dates, exposes absences/inactive entities/conflicts and does not publish automatically                             | Copy period by position with skipped inactive/occupied list and preview; saved patterns audited; #14 accepted                 |
| SC-27      | #14   | T031 / T032 / T033 | Preview gives exact additions/removals/changes; filters do not silently narrow or erase unrelated assignments                                 | Batch/copy previews show exact diff and rule reasons; full-month writes retained; #14 accepted                                |
| SC-28      | #7    | T010 / T011 / T012 | Undo/redo restores assignment data, including zone and metadata; it never rolls back a published decision                                     | Undo/redo metadata regressions and browser undo after redesign; #7 accepted                                                   |
...
| SC-30      | #6    | T007 / T008 / T009 | The primary day view works at 390px without page-level horizontal scrolling; create/replace/review remain usable with touch and keyboard      | Redesign: 390px day list, Playwright touch tap opens Sheet, keyboard open/return asserted                                     |
| SC-31      | #14   | T031 / T032 / T033 | Drag and the explicit Move action invoke equivalent validation/preview; invalid drops leave the plan unchanged                                | Drag and Move share moveAssignment; invalid drops leave the plan unchanged with a reason; #14 accepted                        |
...
| SC-34      | #17   | T040 / T041 / T042 | Only the current permitted approval step is actionable; request and all affected schedule changes remain atomic                               | Current step key and total shown; decisions only through Requests route checks; #17 accepted                                  |
...
| SC-38      | #17   | T040 / T041 / T042 | Source unit and its staffing impact are visible to authorized users; both scopes and the agreed approval route are checked at commit          | Borrowing shows source unit and planned/free; site authority rechecked at commit; #17 accepted                                |
| SC-39      | #18   | T043 / T044 / T045 | Notes have clear audience and visibility; long text cannot stretch the page or disclose restricted information                                | Notes carry audience PLANNERS/EMPLOYEES; bot shows only employee notes; text bounded and scrollable; #18 accepted             |
| SC-40      | #18   | T043 / T044 / T045 | A link opens the correct permitted record; the calendar does not duplicate checklist or handover completion logic                             | Details link to the shift record and Requests; no completion logic in the calendar; #18 accepted                              |
| SC-41      | #18   | T043 / T044 / T045 | Reports distinguish planned time, recorded work and unknown departure; they do not infer OEE or employee fault                                | Retrospective keeps planned, recorded work and unknown departure apart; no OEE or fault; #18 accepted                         |
| SC-42      | #18   | T043 / T044 / T045 | Print includes period, timezone, publication identity and creation time; unpublished output is clearly marked                                 | Print states period, timezone, version identity and generation time; unpublished marked; #18 accepted                         |
